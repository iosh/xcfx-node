...
impl From<NodeError> for NapiError {
    fn from(error: NodeError) -> Self {
        match error {
            NodeError::InitializationError(msg) => NapiError::from_reason(format!("Initialization Error: {}", msg)),
            NodeError::ConfigurationError(msg) => NapiError::from_reason(format!("Configuration Error: {}", msg)),
